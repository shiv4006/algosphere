  ...
  >
    ...
    <section className="mb-4">
      ...
      <div className={\`\${theme === "dark" ? "bg-gray-700" : "bg-gray-100"} p-2 rounded mt-1\`}>
        <span className="block font-mono text-pink-600">Input: [10, 324, 45, 90, 9808]</span>
...
>
  ...
  >
    ...
    <section className="mb-4">
      ...
      <div className={\`\${theme === "dark" ? "bg-gray-700" : "bg-gray-100"} p-2 rounded mt-1\`}>
        <span className="block font-mono text-pink-600">Input: [2, 3, 1, 5, 4]</span>
        <span className="block font-mono text-green-600">Output: Second Smallest = 2, Second Largest = 4</span>
      </div>
    </section>
...
>
  ...
  >
    ...
    <section className="mb-4">
      ...
      <div className={\`\${theme === "dark" ? "bg-gray-700" : "bg-gray-100"} p-2 rounded mt-1\`}>
        <span className="block"><span className="font-mono text-pink-600">Input:</span> nums = [2,1,3,4]</span>
        <span className="block"><span className="font-mono text-green-600">Output:</span> false</span>
      </div>
      <div className={\`\${theme === "dark" ? "bg-gray-700" : "bg-gray-100"} p-2 rounded mt-1\`}>
        <span className="block"><span className="font-mono text-pink-600">Input:</span> nums = [1,2,2,3]</span>
        <span className="block"><span className="font-mono text-green-600">Output:</span> true</span>
      </div>
    </section>
